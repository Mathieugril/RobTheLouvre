...
public class Text {
    ...
    public static class Descriptions {
        ...
        public static final String REGALIA = "see a glittering hall of crown jewels and diadems behind glass cases. Spotlights and no public make this the obvious prize zone.";
        ...
        public static final String JANITOR = "see buckets, mops and cleaning supplies in tight quarters. An old door behind stacked carts is interesting.";
        ...
        public static final String GARDEN = "are in a dim underground garage: engine rumble, an exit ramp to the street and the faint hum of air-conditioning.";
    ...
    public static class Details {
        ...
        public static final String LOBBY_DET = "The sheer amount of people would make it easy to blend in. You see a guard not paying attention. His name badge displays 'Henry Dumoulin'";
        public static final String REGALIA_DET = "The is illuminated via the window and spotlights. Two guards are taking a break on a bench on the other side of the hall, with all the displays it would be easy to get close without being spotted.";
        ...
        public static final String JANITOR_DET = "The cramped closet smells of bleach. An old, taped-up door behind stacked carts is interesting.";
        ...
        public static final String PASSAGE_DET = "Old blueprints and staff scribbles mark this 'staff only' route.";
    ...
    public static class ItemDESC {
        ...
        public static final String GUM =  "Not much use other then it helps with fresh breath.";
        public static final String SMOKES = "Probably helping him by taking these.";
